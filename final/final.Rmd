...
dat <- dat %>% 
  mutate(across(c(Kişi_Başı_Milli_Gelir, Gini_Endeksi, Insan_Sermayesi_Endeksi, Nüfus, GSYH, Işsizlik_Oranı),
                as.numeric))
...
dat %>%
  select("Mutluluk_Skoru", "Kişi_Başı_Milli_Gelir", "Gini_Endeksi", "Insan_Sermayesi_Endeksi", "Nüfus", "Işsizlik_Oranı", "Hukuk_Skoru") %>% 
