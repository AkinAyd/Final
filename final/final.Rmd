...
```
Son sayısal değişken olan hukuk endeksi, bir devletin ne kadar hukuk devleti olduğunu ve bir ülkedeki işlerin ne kadar hukuka bağlı kalınarak gittiğini gösteren bir ölçüttür. Yapılan regresyon analizinin sonuçları (Tablo \ref{tab:mutlulukissizlik})'de gözükmektedir. Analizden elde edilen denklem şu şekildedir:
$$
